...
package org.switchyard.transformation;
...
public class TransformerRegistryLoader {
    ...
    private TransformerFactory<?> getTransformerFactory(TransformModel transformModel) {
        ...
        if (!TransformerFactory.class.isAssignableFrom(factoryClass)) {
            throw new SwitchYardException("Invalid TransformerFactory implementation.  Must implement '" + org.switchyard.transformation.TransformerFactory.class.getName() + "'.");
        }
