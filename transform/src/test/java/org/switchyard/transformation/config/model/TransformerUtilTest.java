...
package org.switchyard.transformation.config.model;
...
import org.switchyard.transformation.TransformerTypes;
...
public class TransformerUtilTest {
    ...
    public void test_transform_unknown() {
        try {
            ...
            Assert.assertEquals("Error constructing Transformer instance for class 'org.switchyard.transformation.config.model.TransformerUtilTest$TestTransformer'.  " +
