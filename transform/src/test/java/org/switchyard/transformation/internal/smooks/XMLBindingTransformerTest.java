...
package org.switchyard.transformation.internal.smooks;
...
import org.switchyard.transformation.config.model.v1.V1SmooksTransformModel;
import org.switchyard.transformation.smooks.internal.SmooksTransformFactory;
...
public class XMLBindingTransformerTest extends AbstractTransformerTestCase {
    ...
    public void test_invalid_xml2java_config() throws IOException, SAXException {
        ...
        model.setConfig("/org/switchyard/transformation/internal/smooks/smooks-config-01.xml");
        try {
    ...
    public void test_java2xml_invalid_type() throws IOException, SAXException {
        ...
        try {
            ...
            Assert.assertEquals("Cannot transform to XML.  Input type is 'java.lang.String' but should be 'org.switchyard.transformation.internal.smooks.Person'.", e.getMessage());
        }
    }
}
