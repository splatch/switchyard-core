...
package org.switchyard.validation;
...
public final class ValidatorUtil {
    ...
    private static ValidatorFactory newValidatorFactory(ValidateModel validateModel) {
        ...
        if (!org.switchyard.validation.ValidatorFactory.class.isAssignableFrom(factoryClass)) {
            throw new SwitchYardException("Invalid ValidatorFactory implementation.  Must implement '" + org.switchyard.validation.ValidatorFactory.class.getName() + "'.");
        }

        try {
            return (org.switchyard.validation.ValidatorFactory) factoryClass.newInstance();
        } catch (Exception e) {
