...
package org.switchyard.validation.config.model;
...
import org.switchyard.validation.config.model.JavaValidateModel;
import org.switchyard.validation.config.model.XmlSchemaType;
import org.switchyard.validation.config.model.XmlValidateModel;
import org.switchyard.validation.config.model.v1.V1JavaValidateModel;
import org.switchyard.validation.config.model.v1.V1XmlValidateModel;
...
public class ValidateModelTests {
    ...
    private static final String XML = "/org/switchyard/validation/config/model/ValidateModelTests.xml";
