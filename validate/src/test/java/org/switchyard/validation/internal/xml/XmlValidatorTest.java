...
package org.switchyard.validation.internal.xml;
...
import org.switchyard.validation.AbstractValidatorTestCase;
import org.switchyard.validation.xml.XmlValidator;
   ...
   private DocumentBuilder builder;
    ...
    public void test_invalid_schemafile() throws IOException, SAXException {
        ...
        try {
            ...
            Assert.assertEquals("Error during validation with '/org/switchyard/validation/internal/xml/person-invalid.xsd' as 'XML_SCHEMA'.", e.getMessage());
        }
    }
    ...
    public void test_invalid_xml() throws IOException, SAXException {
        ...
        try {
            ...
            Assert.assertEquals("Error during validation with '/org/switchyard/validation/internal/xml/person.xsd' as 'XML_SCHEMA'.", e.getMessage());
        }
    }
